...
from apps.submit.service import SubmitService
from common.database import get_db_session
from common.middleware.rate_limit import get_redis_client, rate_limit
...
def _build_character_rest(input: CharacterSubmitMutationInput) -> CharacterSubmitRest:
    from apps.submit.schemas import CharacterSubmit as CharacterSubmitPydantic
...
def _build_music_rest(input: MusicSubmitMutationInput) -> MusicSubmitRest:
    from apps.submit.schemas import MusicSubmit as MusicSubmitPydantic
...
def _build_cp_rest(input: CPSubmitMutationInput) -> CPSubmitRest:
    from apps.submit.schemas import CPSubmit as CPSubmitPydantic
    return CPSubmitRest(
...
def _build_dojin_rest(input: DojinSubmitMutationInput) -> DojinSubmitRest:
    from apps.submit.schemas import DojinSubmit as DojinSubmitPydantic
