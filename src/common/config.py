...
class Settings(BaseSettings):
    ...
    aliyun_pnvs_access_key_id: str | None = Field(
        default=None, alias="ALIYUN_PNVS_ACCESS_KEY_ID"
    )
    aliyun_pnvs_access_key_secret: str | None = Field(
        default=None, alias="ALIYUN_PNVS_ACCESS_KEY_SECRET"
    )
    aliyun_pnvs_endpoint: str | None = Field(default=None, alias="ALIYUN_PNVS_ENDPOINT")
    aliyun_pnvs_region_id: str | None = Field(
        default=None, alias="ALIYUN_PNVS_REGION_ID"
    )
    aliyun_pnvs_scheme_name: str | None = Field(
        default=None, alias="ALIYUN_PNVS_SCHEME_NAME"
    )
    aliyun_pnvs_sms_sign_name: str | None = Field(
        default=None, alias="ALIYUN_PNVS_SMS_SIGN_NAME"
    )
    aliyun_pnvs_sms_template_code: str | None = Field(
        default=None, alias="ALIYUN_PNVS_SMS_TEMPLATE_CODE"
    )
    aliyun_pnvs_code_length: int | None = Field(
        default=None, alias="ALIYUN_PNVS_CODE_LENGTH"
    )
    aliyun_pnvs_valid_time: int | None = Field(
        default=None, alias="ALIYUN_PNVS_VALID_TIME"
    )
    aliyun_pnvs_interval: int | None = Field(default=None, alias="ALIYUN_PNVS_INTERVAL")

    # Aliyun Direct Mail
    aliyun_dm_access_key_id: str | None = Field(
        default=None, alias="ALIYUN_DM_ACCESS_KEY_ID"
    )
    aliyun_dm_access_key_secret: str | None = Field(
        default=None, alias="ALIYUN_DM_ACCESS_KEY_SECRET"
    )
    ...
    aliyun_dm_account_name: str | None = Field(
        default=None, alias="ALIYUN_DM_ACCOUNT_NAME"
    )
    ...
    aliyun_dm_smtp_username: str | None = Field(
        default=None, alias="ALIYUN_DM_SMTP_USERNAME"
    )
    aliyun_dm_smtp_password: str | None = Field(
        default=None, alias="ALIYUN_DM_SMTP_PASSWORD"
    )
