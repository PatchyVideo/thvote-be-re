...
> **状态**：部分实施 —— 本稿覆盖的 8 项中 B-007/B-017/B-018/B-025/B-027/B-029/B-030 均已完成（各自完成日期与 commit 见 [BACKLOG-archive.md](../../BACKLOG-archive.md)），唯 B-008（MongoDB → PostgreSQL 历史用户数据回填脚本）仍在 [BACKLOG.md](../../BACKLOG.md) 开放，仓库 `scripts/` 目录下无对应脚本。
