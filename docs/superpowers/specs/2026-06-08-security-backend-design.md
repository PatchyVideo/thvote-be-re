...
> **状态**：已实施 —— B-037 安全块的后端与管理端（提名合法性校验/审核队列/提名时间窗/问卷弱门禁）已于 2026-06-08 完成并在 2026-07-14 随 `zfq_dev` 分支合并 `main`，见 [BACKLOG](../../BACKLOG.md) B-037 与 [CHANGELOG](../../CHANGELOG.md) 2026-07-14 条目。
