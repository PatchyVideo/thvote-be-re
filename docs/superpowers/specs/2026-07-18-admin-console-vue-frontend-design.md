...
> **状态**：部分实施 —— [BACKLOG B-049](../../BACKLOG.md) 记录前端 Plan 2 Phase 1+2（仪表盘+5 监控页+Users，及全部 6 个旧工具迁移）已于 2026-07-18 实现；旧面板 `/admin-ui-legacy` 视觉验收后删除、几个无 UI 端点（用户详情钻取/建合并/ranking preview）仍开放。
