...
> **状态**：已实施 —— 后端 v1 已于 2026-07-23 合入 main（zfq_dev 2026-07-20~21 实现，迁移 `12a5f2e6dbed`，见 [CHANGELOG 2026-07-23](../../CHANGELOG.md)）；投票传参切 candidateId 的前置约束（B-050-后补6）已于 2026-08-13 解除，前端已于 2026-08-14 端到端验证切换（见 [BACKLOG](../../BACKLOG.md)）。
