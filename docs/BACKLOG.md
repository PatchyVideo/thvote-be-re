...
| **B-040** | 投票对象迁后端(Block 3B)：角色/音乐 merged_into 去重合并(自动+admin手调) + /vote-objects/characters\|music\|{id} 分类查询；前端角色/音乐/CP 改从后端拉 | 大（**设计稿+plan 已写,实现未做**） | 🟢 可独立做 | 后端[design](./superpowers/specs/2026-06-08-vote-objects-backend-design.md)/[plan](./superpowers/plans/2026-06-08-vote-objects-backend.md)；前端[design](./superpowers/specs/2026-06-08-vote-objects-frontend-design.md)/[plan](./superpowers/plans/2026-06-08-vote-objects-frontend.md) |
