...
| **B-039** | 问卷结构化系统(Block 3A)：后端 4 结构表 + admin CRUD + 整树导入 + structure 查询 + 结构化答题 + 完成校验升级；前端 questionnaireV2 改从后端拉(一次性切换) | 大（**设计稿+plan 已写,实现未做**） | 🟡 门禁升级依赖 B-037 | 后端[design](./superpowers/specs/2026-06-08-questionnaire-backend-design.md)/[plan](./superpowers/plans/2026-06-08-questionnaire-backend.md)；前端[design](./superpowers/specs/2026-06-08-questionnaire-frontend-design.md)/[plan](./superpowers/plans/2026-06-08-questionnaire-frontend.md) |
| **B-040** | 投票对象迁后端(Block 3B)：角色/音乐 merged_into 去重合并(自动+admin手调) + /vote-objects/characters\|music\|{id} 分类查询；前端角色/音乐/CP 改从后端拉 | 大（**设计稿+plan 已写,实现未做**） | 🟡 依赖 B-038 的 /vote-objects/works 样板 | 后端[design](./superpowers/specs/2026-06-08-vote-objects-backend-design.md)/[plan](./superpowers/plans/2026-06-08-vote-objects-backend.md)；前端[design](./superpowers/specs/2026-06-08-vote-objects-frontend-design.md)/[plan](./superpowers/plans/2026-06-08-vote-objects-frontend.md) |
